...
public class TestProperties {
    ...
    public static void main(String[] args) {
        // 注意路径问题
        String properties_1 = getProperties_1("path.properties", "cfgpath");
        System.out.println("a = " + properties_1);
        getProperties_1("path.properties");
		System.out.println(getProperties_1("path.properties","a"));
        System.out.println("*********************************************");
        // 注意路径问题
        /*String properties_2 = getProperties_2("/main/resources/path.properties", "a");
        System.out.println("jdbc.url = " + properties_2);
        getProperties_2("resources/path.properties");
        System.out.println("*********************************************");*/
        
       /* // 注意路径问题
        String properties_3 = getProperties_3("resources/path.properties", "a");
        System.out.println("wechat_appid = " + properties_3);
        getProperties_3("/resources/path.properties");*/
    }
